...
public class GameOver extends JFrame implements ActionListener {
	...
	public GameOver(Game e) {
		...
		Icon icon = new ImageIcon("./Images/gameOver.png");
		...
		// TODO add action lisiner from Game class;

		button = new JPanel(new GridBagLayout());
		font = new Font("", 1, 20);
		restart = new JButton();
		// Icon yesIcon = new ImageIcon("./Images/yes.gif");
		// restart.setIcon(yesIcon);
		...
		// Icon noIcon = new ImageIcon("./Images/no.gif");
		// end.setIcon(noIcon);
		end.setText("cancel");
		end.setFont(font);
